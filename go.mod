...
// Pin a patched toolchain: go1.26.5 carries fixes for the crypto/x509,
// crypto/tls, net/http, html/template and archive/tar stdlib advisories
// flagged by govulncheck against the previous build. See SECURITY_CHANGELOG.md.
toolchain go1.26.5
